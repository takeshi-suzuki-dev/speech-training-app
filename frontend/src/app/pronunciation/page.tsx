          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
              <div className="flex items-start gap-6">
                ...
                <div className="shrink-0">
                  <span
                    className={`text-4xl font-bold font-mono leading-none ${scoreColor(overallScore)}`}
                  >
                    {overallScore}
                  </span>
                ...
                <div className="grid grid-cols-4 gap-4 flex-1">
                  {[
                    {
                      label: "Accuracy",
                      value: result.sentenceScores.accuracy,
                    },
                    { label: "Fluency", value: result.sentenceScores.fluency },
                    {
                      label: "Completeness",
                      value: result.sentenceScores.completeness,
                    },
                    { label: "Prosody", value: result.sentenceScores.prosody },
                  ].map(({ label, value }) => (
                    <div key={label}>
            ...
            <div className="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
              ...
              <div className="divide-y divide-gray-100">
                {result.words.map((wordResult, index) => {
